import { JourneyConfig, JourneyInstance, JourneyStatus } from './types';
        ...
        try {
            ...
            if (this.config.onError) {
                this.config.onError({
                    ...
                    message: error instanceof Error ? error.message : 'Failed to initialise the journey',
                });
            }
            throw error;
        }
        ...
        try {
            ...
            if (this.config.onError) {
                this.config.onError({
                    ...
                    timestamp: Date.now(),
                    name: 'start-error',
                    message: error instanceof Error ? error.message : 'Failed to start the journey',
                });
            }
            throw error;
        }
