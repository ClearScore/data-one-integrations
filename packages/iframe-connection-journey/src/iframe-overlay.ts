...
export class IframeOverlay {
  ...
  hide(): void {
    ...
    this.iframe.style.cssText = this.iframe.style.cssText.replace(
      IFRAME_VISIBLE_STYLES,
      ""
    );

    this.spinner.style.cssText = this.spinner.style.cssText.replace(
      SPINNER_VISIBLE_STYLES,
      ""
    );
    this.loadingText.style.cssText = this.loadingText.style.cssText.replace(
      SPINNER_VISIBLE_STYLES,
      ""
    );
